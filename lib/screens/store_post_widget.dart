...
abstract class StorePostWidget extends StatefulWidget{
  ...
  void createStorePostHeading(BuildContext context, 
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('1 week', style: TextStyle(fontSize: 12, color: Colors.grey))
                      ],
                    ),
                  ),
                ),
  ...
  void incrementNumberOfLikes(){numberOfLikes++;}

  void incrememntNumberOfComments(){numberOfComments++;}

  void incrementNumberOfShares(){numberOfShares++;}
